...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/FMuHvbjF77)
...
```sh
npx nx serve awsfrontend
```

To create a production bundle:

```sh
npx nx build awsfrontend
```

To see all available targets to run for a project, run:

```sh
npx nx show project awsfrontend
```
